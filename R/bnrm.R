...
#'
#' @details Fit a neo-normal model that using brm function in brms package.All options in this functions follow brm function, except family and vec
#'
#' @references
...
prior=prior,autocor = autocor, data2 = data2, cov_ranef = cov_ranef,
sample_prior = sample_prior, sparse = sparse, knots = knots,
drop_unused_levels = drop_unused_levels,  stan_funs = stan_funs,
fit = fit, save_pars = save_pars,
save_ranef = save_ranef, save_mevars = save_mevars, save_all_pars = save_all_pars,
init = init, inits = inits, chains = chains, iter = iter,
